...
\definecolor{emphared}{RGB}{176, 7, 14}
\urlstyle{same}
...
\shorterSection{\textcolor{titleblue}{Publications}}
  \resumeSubHeadingListStart
    \resumeSubheadingone
  		{Journal Paper}{}
  \vspace{-12pt}
   \item{\textcolor{emphared}{\textbf{Zhao S}, Deng Z, Wang Q, Zhang W, Gong X. Terrain Matching Algorithm Based on Trajectory Reconstruction and Correlation Analysis of Sliding Measurement Sequence[J]. \textit{\textbf{IEEE/ASME Transactions on Mechatronics}}, 2024. (SCI Q1, IF: 6.1)}}
  \vspace{-5pt}
   \item{\textcolor{emphared}{\textbf{Zhao S}, Xiao X, Pang X, Wang Y, Deng Z. Gravity Matching Algorithm Based on Backtracking for Small Range Adaptation Area[J]. \textit{\textbf{IEEE Transactions on Instrumentation and Measurement}}, 2024, 73, 9504413. (SCI Q1, IF: 5.6)} \href{https://ieeexplore.ieee.org/document/10381855}{\textcolor{linkblue}{[paper]}}}
  \vspace{-5pt}
  \item{\textcolor{emphared}{\textbf{Zhao S}, Xiao X, Wang Y, Deng Z. An improved particle filter based on gravity measurement feature in gravity-aided inertial navigation system[J].\textit{\textbf{IEEE Sensors Journal}}, 2022, 23(2): 1423-1435. (SCI Q1, IF: 4.3)} \href{https://ieeexplore.ieee.org/document/9979757}{\textcolor{linkblue}{[paper]}}}
  \vspace{-5pt}
  \item{\textcolor{emphared}{\textbf{Zhao S}, Xiao X, Deng Z, Shi L. Gravity matching algorithm based on correlation filter[J]. \textit{\textbf{IEEE Sensors Journal}}, 2022, 23(3): 2618-2629. (SCI Q1, IF: 4.3)} \href{https://ieeexplore.ieee.org/document/9997486}{\textcolor{linkblue}{[paper]}}}
  \vspace{-5pt}
   \item{\textcolor{emphared}{\textbf{Zhao S}, Shi L, Zhang W, Deng Z. Global dynamic path‐planning algorithm in gravity‐aided inertial navigation system[J]. \textit{\textbf{IET Signal Processing}}, 2021, 15(8): 510-520. (SCI Q3, IF: 1.7)} \href{https://ietresearch.onlinelibrary.wiley.com/doi/10.1049/sil2.12056}{\textcolor{linkblue}{[paper]}}}
  \vspace{-5pt}
  \item{Wang Y, Deng Z, Zhang P, Wang B, \textbf{Zhao S}. A Gravity-Aided Navigation Matching Algorithm Based on Triangulation[J]. IEEE Sensors Journal, 2024. (SCI Q1, IF: 4.3)}
	...
	{Conference Paper}{}
  \vspace{-12pt}
	\item{\textcolor{emphared}{\textbf{Zhao S}, Zhang W, Wang Y, Deng Z. The analysis of influencing factors on geophysical field matching[C]//2024 International Conference on Guidance, Navigation and Control (ICGNC), Springer, 2024. (EI)}}
	\vspace{-5pt}
	\item{\textcolor{emphared}{\textbf{Zhao S}, Pang X, Deng Z.  Gravity Matching Algorithm Based on Backtracking[C]// 2022China Inertia Technology Symposium, 2022, Dalian, China.}}
	\vspace{-5pt}
...
\resumeSubheadingone
	...
	{CN202110545814.3 (3rd), \textcolor{emphared}{CN202311811811.5 (2nd)}, CN202311694509.6 (3rd), CN202110545816.2 (3rd), CN202110838109.2 (3rd), CN202211221726.9 (4th), \textcolor{emphared}{CN202210856742.9 (2nd)}, CN201911385476.0 (4th).}
  \resumeSubHeadingListEnd
  %-------------------------------------------
...
\resumeSubHeadingListStart
	\resumeSubheadingtwo
	{\textcolor{emphared}{Technical Invention Award of Chinese Society of Inertial Technology (\textbf{First Prize})}}{Aug, 2022}
	\vspace{-12pt}
 	\resumeSubheadingtwo
 {\textcolor{emphared}{APMCM Mathematical Modeling (\textbf{First Prize, TOP 4})}}{Jan, 2022}
 \vspace{-12pt}
 \resumeSubheadingtwo
 {\textcolor{emphared}{Huawei Cup Mathematical Modeling (\textbf{Third Prize})}}{Dec, 2021}
  \vspace{-12pt}
 \resumeSubheadingtwo
 {\textcolor{emphared}{MathorCup Mathematical Modeling (\textbf{Third Prize})}}{Jun, 2021}
   \vspace{-12pt}
 \resumeSubheadingtwo
